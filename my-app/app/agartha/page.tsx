...
import { Shield, Zap, FileCheck, ArrowRight, CheckCircle, ChevronLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center gap-1 text-sm text-slate-400 hover:text-white transition-colors mb-8 animate-slide-up"
        >
        ...
        <footer className="mt-12 text-center text-sm text-slate-500">
          <p>
            Built for Agartha AI Compliance • Powered by Gemini & GPT-4o
          </p>
